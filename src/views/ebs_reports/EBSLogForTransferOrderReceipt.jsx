...
const EBSLogForTransferOrderReceipt = () => {
  const ebs_log_for_transfer_order_receipt_columns = [
    ...
    { field: "receipt_date", headerName: "Receipt Date", width: 100 },
    {
      field: "from_store",
  ...
  const ebs_log_for_transfer_order_receipt_rows = [
    {
      id: 1,
      transfer_type: "",
      receipt_date: "",
    ...
    <>
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={4} alignItems="center" sx={{ px: 2 }}>
          {/* <SubHeader text="EBS Log for Transfer Order Receipt" /> */}
          <Grid
            item
            xs={12}
              ...
              <Grid container spacing={2} alignItems="center">
                ...
                <Grid item container alignItems="center" sx={{ px: 2 }} xs={12}>
                  <div style={{ height: "auto", width: "100%" }}>
                    <DataGrid
                      rows={ebs_log_for_transfer_order_receipt_rows?.map((row, index) => ({
                        ...row,
                        sl: index + 1,
                      }))}
                      columns={ebs_log_for_transfer_order_receipt_columns}
                      initialState={{
                        pagination: {
...
export default EBSLogForTransferOrderReceipt;
