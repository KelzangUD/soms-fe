...
const EBSLogForSalesReturn = () => {
  const ebs_log_for_sales_return_columns = [
    ...
    { field: "sub_inv", headerName: "Sub-Inv", width: 150 },
    ...
    <>
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={4} alignItems="center" sx={{ px: 2 }}>
          <SubHeader text="EBS Log for Sales Return" />
          <Grid
            item
            xs={12}
              ...
              <Grid container spacing={2} alignItems="center">
                ...
                <Grid item container alignItems="center" sx={{ px: 2 }} xs={12}>
                  <div style={{ height: "auto", width: "100%" }}>
                    <DataGrid
                      rows={ebs_log_for_sales_return_rows?.map((row, index) => ({
                        ...row,
                        sl: index + 1,
                      }))}
                      columns={ebs_log_for_sales_return_columns}
                      initialState={{
                        pagination: {
...
export default EBSLogForSalesReturn;
